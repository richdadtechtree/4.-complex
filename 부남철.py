...
class RealEstateAnalyzerApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("📊 부남철의 실거래가 차트")  # 이모지 추가
    ...
    def setup_gui(self):
        ...
        # 제목 레이블 (더 크고 눈에 띄게)
        title_label = ttk.Label(main_frame, text="📊 부남철의 실거래가 차트",
                               style='Title.TLabel')
        ...
        self.footer_label = ttk.Label(main_frame, text="만든이 부남철", 
    ...
    def create_multi_chart(self, apt_dfs, monthly_dfs, jeonse_dfs=None, monthly_jeonse_dfs=None):
        ...
        # 차트 제목 변경 - '부남철의 실거래가 비교 분석'으로 변경
        title_text = "부남철의 실거래가 비교 분석\n"
        ...
        ax.text(0.99, 0.01,
                f'만든이 부남철 : https://blog.naver.com/landlover333',
                fontsize=12,
                color='#3366CC',
                alpha=0.7,
